...
namespace TreeOfLife.Core.Validation
{
    ...
    {
        public override string ToString() => "未灭绝类群不应具有灭绝年代，已灭绝类群的灭绝年代不应是现代";
    ...
    public class TimelineConsistencyValidator : IValidator
    {
        ...
        public bool IsValid(Taxon taxon) => !taxon.IsExtinct || taxon.Birth <= taxon.Extinction;
    }
    ...
    {
#if DEBUG
        public override string ToString() => "学名缺失";
#endif
    ...
    {
#if DEBUG
        public override string ToString() => "分级缺失";
#endif
    ...
    {
#if DEBUG
        public override string ToString() => "异名或标签存在重复项";
#endif
